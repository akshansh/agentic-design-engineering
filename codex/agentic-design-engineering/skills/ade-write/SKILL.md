...
Before rewriting anything, run the `write-auditor` skill on the existing code to establish baseline scores. Record the scores — you'll compare against these after all rewrites.
