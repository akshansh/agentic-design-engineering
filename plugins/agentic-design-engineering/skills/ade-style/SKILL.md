...
Before transforming anything, run the `style-auditor` agent on the existing code to establish baseline scores. Record the scores — you'll compare against these after transformation.
