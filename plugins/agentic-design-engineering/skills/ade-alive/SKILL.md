...
Before injecting anything, run the `alive-auditor` agent on the existing code to establish baseline scores. Record the scores — you'll compare against these after all injections.
