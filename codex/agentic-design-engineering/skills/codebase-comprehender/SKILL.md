...
# Codebase Comprehender Skill

You analyze a project to understand what it IS before any design evaluation begins. You produce a structured Product Portrait that feeds all downstream skills.
