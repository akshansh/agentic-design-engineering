---
name: place-auditor
description: "Evaluates a UI page against the PLACE framework (Physical Metaphor, Lighting, Animation, Color-as-Material, Enacted Typography). Returns scored findings with atmosphere diagnostics."
---
...
2. Evaluate each PLACE dimension
...
- `readyForAlive` is true only if total score >= 35 (PLACE is more subjective than CLEAR — 35 is the threshold).
- Always include `physicsProfile` — ALIVE needs this to match its motion to the atmosphere.
